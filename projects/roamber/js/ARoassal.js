...
args: [],
source: "initialize\x0a\x09super initialize.\x0a\x09elements := OrderedCollection new.",
...
smalltalk.addClass('ROAbstractPathShape', smalltalk.ROShape, ['mySvgRect', 'mySvgPath'], 'ARoassal');
smalltalk.addMethod(
smalltalk.method({
...
var self=this;
return smalltalk.withContext(function($ctx1) { 
self["@mySvgRect"]=self._initializeContainterOn_for_(canvas,anElement);
self["@mySvgPath"]=self._initializePathOn_for_(canvas,anElement);
self._resizeContainer_for_with_(self["@mySvgRect"],self["@mySvgPath"],anElement);
self._centeringPath_into_with_(self["@mySvgPath"],self["@mySvgRect"],anElement);
self._createSetWith_and_on_for_(self["@mySvgRect"],self["@mySvgPath"],canvas,anElement);
...
args: ["canvas", "anElement"],
source: "initializeSVGElementOn: canvas for: anElement\x0a\x0a\x09\x0a\x09mySvgRect := self initializeContainterOn: canvas for: anElement.\x0a\x09mySvgPath := self initializePathOn: canvas for: anElement.\x0a\x09\x0a\x09self resizeContainer: mySvgRect for: mySvgPath with: anElement. \x0a\x09self centeringPath: mySvgPath into: mySvgRect with: anElement.\x0a\x09self createSetWith: mySvgRect and: mySvgPath on: canvas for: anElement.",
...
$ctx1.sendIdx[","]=1;
_st($1)._transform_($2);
_st(self["@mySvgPath"])._attr_value_("fill",_st(self._color())._asHTMLRGBA());
...
args: ["canvas", "anElement"],
source: "updateSVGElementOn: canvas for: anElement\x0a\x09svgElement transform: 'T0,0'.\x0a\x09svgElement transform: 'T',(anElement position x),',',(anElement position y).\x0a\x09mySvgPath attr: 'fill' value: (self color asHTMLRGBA).\x0a\x22\x0a\x09svgElement translate: 0 y: 0.\x0a\x09svgElement translate: (anElement position x) y: (anElement position y).\x0a\x22",
...
return smalltalk.withContext(function($ctx1) { 
var $2,$4,$3,$1,$5;
$2=self._widthFor_(anElement);
$4=self._defaultExtent();
$ctx1.sendIdx["defaultExtent"]=1;
$3=_st($4)._x();
$1=_st($2)._max_($3);
$ctx1.sendIdx["max:"]=1;
_st(svgRect)._attr_with_("width",$1);
$ctx1.sendIdx["attr:with:"]=1;
$5=_st(svgRect)._attr_with_("height",_st(self._heightFor_(anElement))._max_(_st(self._defaultExtent())._y()));
...
return smalltalk.withContext(function($ctx1) { 
var $3,$2,$1;
$3=_st(svgRect)._attr_("width");
$ctx1.sendIdx["attr:"]=1;
$2=_st($3).__slash((2));
$ctx1.sendIdx["/"]=1;
$1=_st($2)._asInteger();
$ctx1.sendIdx["asInteger"]=1;
_st(svgPath)._attr_value_("x",$1);
$ctx1.sendIdx["attr:value:"]=1;
...
args: ["svgPath", "svgRect", "anElement"],
source: "centeringPath: svgPath into: svgRect  with: anElement\x0a\x09svgPath attr: 'x' value: ((svgRect attr: 'width') / 2) asInteger.\x0a\x09svgPath attr: 'y' value: ((svgRect attr: 'height') / 2) asInteger.\x0a\x09svgPath  attr: 'text-anchor' value: 'middle'.",
...
args: ["canvas", "anElement"],
source: "initializePathOn: canvas for: anElement\x0a\x09^ canvas text: 0\x0a\x09\x09\x09y:10\x0a\x09\x09\x09string: (self text).",
...
$1=_st(_st(textBBox)._width()).__plus((5));
$ctx1.sendIdx["+"]=1;
_st(svgRect)._attr_value_("width",$1);
$ctx1.sendIdx["attr:value:"]=1;
...
args: ["svgRect", "svgPath", "anElement"],
source: "resizeContainer: svgRect for: svgPath  with: anElement\x0a\x0a\x09| textBBox |\x0a\x09textBBox := svgPath getBBox.\x09\x0a\x09svgRect attr: 'width'  value: (textBBox width + 5).\x0a\x09svgRect attr: 'height' value:(textBBox height + 5).",
...
return smalltalk.withContext(function($ctx1) { 
var $1,$2;
$1=_st($SmallInteger())._minVal();
$ctx1.sendIdx["minVal"]=1;
bottomRight=_st($1).__at(_st($SmallInteger())._minVal());
...
$ctx2.sendIdx["max:"]=1;
return bottomRight;
}, function($ctx2) {$ctx2.fillBlock({lineAsAssoc:lineAsAssoc},$ctx1,1)})}));
$2=bottomRight;
return $2;
...
messageSends: ["@", "minVal", "do:", "lines", "max:", "key", "value"],
...
$1=_st($2).__plus($3);
$ctx2.sendIdx["+"]=1;
return _st(aCanvas)._line_to_width_color_($1,_st(_st(assoc)._value()).__plus(_st(b)._topLeft()),w,bc);
}, function($ctx2) {$ctx2.fillBlock({assoc:assoc},$ctx1,1)})}));
...
messageSends: ["absoluteBoundsFor:", "roValue:", "do:", "lines", "line:to:width:color:", "+", "key", "topLeft", "value"],
referencedClasses: []
}),
smalltalk.ROSVGPath);
...
messageSends: ["corner:", "topLeftFromSVG", "bottomRightFromSVG"],
referencedClasses: []
}),
smalltalk.ROSVGPath);
...
messageSends: ["max:", "extentFor:", "preferedExtentFor:"],
referencedClasses: []
}),
smalltalk.ROSVGPath);
...
return smalltalk.withContext(function($ctx2) {
$1=_st(_st(assoc)._key()).__minus(aPoint);
$ctx2.sendIdx["-"]=1;
return _st($1).__minus_gt(_st(_st(assoc)._value()).__minus(aPoint));
}, function($ctx2) {$ctx2.fillBlock({assoc:assoc},$ctx1,1)})}));
...
messageSends: ["collect:", "lines", "->", "-", "key", "value"],
referencedClasses: []
}),
smalltalk.ROSVGPath);
...
if(smalltalk.assert($2)){
$3=self._bottomRightFromSVG();
$ctx1.sendIdx["bottomRightFromSVG"]=1;
$1=_st($3).__minus(self._topLeftFromSVG());
} else {
...
messageSends: ["ifTrue:ifFalse:", "-", "bottomRightFromSVG", "topLeftFromSVG"],
referencedClasses: []
}),
smalltalk.ROSVGPath);
...
return smalltalk.withContext(function($ctx1) { 
var $1,$3,$2,$5,$4,$6,$7,$10,$9,$12,$11,$8,$14,$13,$15,$16,$17,$19,$18,$21,$20,$22,$23,$24,$25,$28,$27,$26,$29,$30;
p=(0).__at((0));
$ctx1.sendIdx["@"]=1;
initialPoint=nil;
...
$3=_st(stream)._next();
$ctx2.sendIdx["next"]=2;
$2=_st($Float())._readFrom_($3);
$ctx2.sendIdx["readFrom:"]=1;
$5=_st(stream)._next();
$ctx2.sendIdx["next"]=3;
$4=_st($Float())._readFrom_($5);
$ctx2.sendIdx["readFrom:"]=2;
p=_st($2).__at($4);
$ctx2.sendIdx["@"]=2;
p;
initialPoint=nil;
...
$10=_st(stream)._next();
$ctx2.sendIdx["next"]=4;
$9=_st($Float())._readFrom_($10);
$ctx2.sendIdx["readFrom:"]=3;
$12=_st(stream)._next();
$ctx2.sendIdx["next"]=5;
$11=_st($Float())._readFrom_($12);
$ctx2.sendIdx["readFrom:"]=4;
$8=_st($9).__at($11);
$ctx2.sendIdx["@"]=3;
p=_st($7).__plus($8);
$ctx2.sendIdx["+"]=1;
...
$15=answer;
$16=_st(p).__minus_gt(initialPoint);
$ctx2.sendIdx["->"]=1;
_st($15)._add_($16);
$ctx2.sendIdx["add:"]=1;
initialPoint=nil;
...
$19=_st(stream)._next();
$ctx2.sendIdx["next"]=6;
$18=_st($Float())._readFrom_($19);
$ctx2.sendIdx["readFrom:"]=5;
$21=_st(stream)._next();
$ctx2.sendIdx["next"]=7;
$20=_st($Float())._readFrom_($21);
$ctx2.sendIdx["readFrom:"]=6;
t=_st($18).__at($20);
$ctx2.sendIdx["@"]=4;
t;
$22=answer;
$23=_st(p).__minus_gt(t);
$ctx2.sendIdx["->"]=2;
_st($22)._add_($23);
$ctx2.sendIdx["add:"]=2;
p=t;
...
$28=_st(stream)._next();
$ctx2.sendIdx["next"]=8;
$27=_st($Float())._readFrom_($28);
$ctx2.sendIdx["readFrom:"]=7;
$26=_st($27).__at(_st($Float())._readFrom_(_st(stream)._next()));
t=_st($25).__plus($26);
t;
...
$29=initialPoint;
if(($receiver = $29) == nil || $receiver == null){
initialPoint=p;
return initialPoint;
} else {
return $29;
...
messageSends: ["@", "new", "copyReplaceAll:with:asTokens:", "findTokens:keep:", "on:", "whileFalse:", "atEnd", "next", "ifTrue:", "=", "readFrom:", "+", "or:", "add:", "->", "ifNil:", "asArray"],
...
return smalltalk.withContext(function($ctx1) { 
var $1,$2;
$1=_st($SmallInteger())._maxVal();
$ctx1.sendIdx["maxVal"]=1;
topLeft=_st($1).__at(_st($SmallInteger())._maxVal());
_st(self._lines())._do_((function(lineAsAssoc){
return smalltalk.withContext(function($ctx2) {
...
messageSends: ["@", "maxVal", "do:", "lines", "min:", "key", "value"],
referencedClasses: ["SmallInteger"]
}),
smalltalk.ROSVGPath);
