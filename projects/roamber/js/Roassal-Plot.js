define("roamber/Roassal-Plot", ["amber_vm/smalltalk", "amber_vm/nil", "amber_vm/_st", "amber_core/Kernel-Objects", "roamber/ARoassal-Test"], function(smalltalk,nil,_st){
...
return _st(str).__eq("");
}, function($ctx2) {$ctx2.fillBlock({str:str},$ctx1,1)})})))._collect_("asNumber");
return $1;
...
messageSends: ["ifFalse:", "=", "size", "error:"],
referencedClasses: []
}),
smalltalk.ROData);
...
args: ["aString"],
source: "rawData: aString\x0a\x09^ self new rawData: aString.",
...
args: ["aString", "token"],
source: "rawData: aString withToken: token\x0a\x09^ self new rawData: aString; token: token; yourself",
...
args: ["token"],
source: "token: token\x0a\x09^ self new token: token; yourself",
...
$2=_st(self["@data"])._asArray();
$ctx1.sendIdx["asArray"]=1;
$1=_st($2).__eq([(1), (4), (9), (2), (23), (45), (63)]);
$ctx1.sendIdx["="]=1;
self._assert_($1);
...
$4=_st(self["@data"])._asArray();
$ctx1.sendIdx["asArray"]=2;
$3=_st($4).__eq([(1), (4), (9), (2), (23), (45), (63)]);
$ctx1.sendIdx["="]=2;
self._assert_($3);
...
$1=_st($ROData())._new();
$ctx2.sendIdx["new"]=1;
return _st($1)._token_(",,");
$ctx2.sendIdx["token:"]=1;
...
$1=jQuery;
$2=self._url();
$4="type".__minus_gt("GET");
$ctx1.sendIdx["->"]=1;
$5="success".__minus_gt((function(rawData){
return smalltalk.withContext(function($ctx2) {
return _st(self["@data"])._rawData_from_(rawData,self);
}, function($ctx2) {$ctx2.fillBlock({rawData:rawData},$ctx1,1)})}));
$ctx1.sendIdx["->"]=2;
$3=smalltalk.HashedCollection._from_([$4,$5,"error".__minus_gt((function(){
return smalltalk.withContext(function($ctx2) {
