define("roamber/RoassalD3", ["amber_vm/smalltalk", "amber_vm/nil", "amber_vm/_st", "amber_core/Kernel-Objects"], function(smalltalk,nil,_st){
smalltalk.addPackage('RoassalD3');
smalltalk.packages["RoassalD3"].transport = {"type":"amd","amdNamespace":"roamber"};
...
var self=this;
return smalltalk.withContext(function($ctx1) { 
smalltalk.ROSVGCanvas.superclass.fn.prototype._initialize.apply(_st(self), []);
self["@svgCanvas"]="#svgCanvas"._asJQuery();
